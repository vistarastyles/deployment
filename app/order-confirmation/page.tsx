// mark this route dynamic so that it always re-runs on the server
...
export default async function OrderConfirmation({ params }: Props) {
  ...
  console.warn("⚠️ No paymentId in params — returning 404");
  if (!paymentId) return notFound();

  // fetch the order that was updated by the webhook
  ...
  // estimate delivery in 6 days (5–7 business days)
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="bg-slate-800/50 p-6 rounded-2xl mb-8">
          ...
          {items.map((i) => (
            <div
              key={i.productId}
              className="flex justify-between mb-2 text-slate-300"
            >
              <div>
                {i.title} × {i.quantity}{" "}
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">
                    Ensure someone is available at your address.
                  </p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">
                    7-day return policy if you’re unsatisfied.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 text-center space-y-4">
            <button className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-semibold">
              Continue Shopping <ArrowRight className="w-5 h-5" />
            </button>
            <button className="inline-flex items-center gap-2 border border-slate-600 text-slate-300 hover:bg-slate-700/50 px-8 py-3 rounded-xl font-medium">
              View Order History
            </button>
          </div>
        </div>
